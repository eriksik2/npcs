...
public class ModWidgetScreen extends Screen {

    private ModWidget debug;
    private ModWidget root;

    protected ModWidgetScreen(Component name) {
        super(name);
    ...
    public <T extends ModWidget> T addWidget(T widget) {
